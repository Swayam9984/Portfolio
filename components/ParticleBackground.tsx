...
export default function ParticleBackground() {
  ...
  useEffect(() => {
    ...
    const colors = ['#00f0ff', '#a855f7', '#ec4899', '#3b82f6', '#00ff88']
    ...
    const animate = () => {
      ...
      // Update and draw particles with neon effects
      particles.forEach((particle) => {
        ...
        // Pulsing radius for neon effect
        ...
        ctx.globalAlpha = (particle.opacity * 0.3) + Math.sin(particle.pulse) * 0.1
        ctx.fill()
        ctx.globalAlpha = 1.0
